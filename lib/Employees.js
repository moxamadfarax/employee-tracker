...
const addEmp = () => {
  ...
  // Getting data from managers table and storing it in managers array and joining the first and last names together.
  ...
  inquirer
    ...
    .then((data) => {
      ...
      SELECT id, first_name, last_name FROM employees WHERE is_manager = TRUE;`,
        (err) => {
          if (err) {
            console.log(err.message);
          }
...
const updateEmp = async () => {
  ...
  inquirer
    ...
    .then((data) => {
      // Joining the first and last names of the employee back together.
